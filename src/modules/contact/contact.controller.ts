...
export class ContactController {
  ...
  @ApiOperation({ 
    ...
    description: 'Envía un mensaje desde el formulario de contacto público al equipo de Copexia'
  })
  @ApiResponse({ 
    status: 200, 
  ...
  @ApiBadRequestResponse({ 
    ...
    schema: {
      ...
      properties: {
        ...
        message: { type: 'array', items: { type: 'string' }, example: ['El nombre completo es requerido'] },
